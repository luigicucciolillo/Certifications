# Advanced Cloud Engineer IT Professional Program Logistics (LFS002)

Issued by The Linux Foundation<br>

8 moths<br>

official link [here](https://training.linuxfoundation.org/training/advanced-cloud-engineer-it-professional-program/)

The *Advanced Cloud Engineer IT Professional Program* provides a solid, end-to-end foundation in modern cloud-native infrastructure, covering the full lifecycle of containerized applications across deployment, orchestration, traffic management, monitoring, packaging, and logging. Through hands-on work with **containers**, **Kubernetes**, **service mesh technologies**, **Prometheus**, **Helm**, **Fluentd**, and **Fluent Bit**, the program builds practical skills in running distributed systems reliably and at scale. Overall, it prepares learners to design, deploy, observe, troubleshoot, and manage production-ready cloud-native platforms using widely adopted open-source tools and DevOps practices.
...
https://www.credly.com/badges/d9c68307-e053-49d7-bbcd-d2133d78d0b3/public_url

Skills: Cloud-native App Architecture, Control Planes, Data Planes, Ingress Controller. Resilience, Service Mesh, Service Mesh Interface (SMI)  
...
Skills: Advanced querying, Batch Jobs, Blackbox monitoring, cAdvisor, Debugging, High Availability, Kubernetes, Monitoring, Monitoring And Alerting
...
https://www.credly.com/badges/caf7f16b-60c4-42b3-a667-5b3eb8ab9b94/public_url

Skills: Debugging, Fluent Bit, Fluentd, Log management solutions, Plugins, Unified Logging Layer